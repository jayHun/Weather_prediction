...
div.content{
  ...
  padding-top: 50px;
	...
	<body>
		...
		<div class='content'>
		<center>
	    <form action="wnomuse" method="post">
			...
			<tr>
				<td>Temperature : </td>
				<td><input type="radio" name="temperature" value="cool">cool
					<input type="radio" name="temperature" value="mild">mild
					<input type="radio" name="temperature" value="hot">hot
				</td>
			</tr>
			<tr>
				<td>Humidity : </td>
				<td><input type="radio" name="humidity" value="normal">normal
					<input type="radio" name="humidity" value="high">high
				</td>
			</tr>
			<tr>
				<td>Windy : </td>
